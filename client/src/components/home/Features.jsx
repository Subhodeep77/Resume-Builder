  ...
  return (
    <div id="features" className="flex flex-col items-center my-10 scroll-mt-12">
      ...
      <div className="flex items-center justify-center flex-wrap gap-6 mt-20 px-4 md:px-0">
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-violet-200 gap-6 max-w-sm cursor-pointer hover:shadow-lg hover:-translate-y-1 transition">
        ...
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-green-200 gap-6 max-w-sm cursor-pointer hover:shadow-lg hover:-translate-y-1 transition">
        ...
        <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-orange-200 gap-6 max-w-sm cursor-pointer hover:shadow-lg hover:-translate-y-1 transition">
