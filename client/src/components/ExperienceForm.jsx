                    ...
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={() => generateJobDescription(index)} disabled={generatingIndex === index || !experience.company || !experience.position} className='flex items-center gap-1 px-2 py-1 text-xs bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
                                    {generatingIndex === index ? (<Loader2 className='w-3 h-3 animate-spin'/>) : (<Sparkles className='w-3 h-3'/>)}
                                    {generatingIndex === index ? 'Enhancing...' : 'Enhance AI'}
                                </button>
                            </div>
